...
\begin{abstract}
The following research paper attempts to compare between two of the most popular low-level systems programming languages: RUST, and C++. We aim to find performance differences between the two by taking the x86 CPU Platform as a baseline, compiling to the Assembly, using a proprietary Assembly Tracer Program built to trace execution, and analyzing the output trace files. 
\end{abstract}
...
formatting. Please note sections \ref{AA}--\ref{SCM} below for more information on proofreading, spelling and grammar.
